...
* [x] Trang users cho phép xem danh sách người dùng có trong hệ thống và phải có nút "add" với những người dùng chưa là bạn để thêm vào danh sách bạn bè.(**564**)
* [x] Trang about thể hiện thông tin nhóm thực hiện đề tài.(**564**)
